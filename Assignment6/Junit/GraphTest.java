...
public class GraphTest {
    ...
    public void testAddVertex() {
        Town newTown = new Town("Town_12", false);
    ...
    public void testContainsVertex() {
        assertEquals(true, graph.containsVertex(new Town("Town_2", true)));
        assertEquals(false, graph.containsVertex(new Town("Town_12", true)));
    }
